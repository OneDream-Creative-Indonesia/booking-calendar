<div class="page" id="pagePhotoGrid">
    ...
    <div style="
        position: absolute;
        top: 131px; left: 0; right: 0; bottom: 0;
        overflow-y: auto;
        display: flex;
    ...
    ">
        <p style="font-family:'Montserrat',sans-serif; font-weight:700; font-size:16px; color:#282828; margin:0;">
            Ketik Nomor Foto
        </p>

        <div id="photoGridCapture" class="capture-wrapper"></div>

        <div style="width:calc(100% - 55px); max-width:320px; display:flex; flex-direction:column; gap:6px; font-family:'Montserrat',sans-serif; font-size:14px; color:#282828;">
            <label style="font-weight:600;">Masukkan Nama Kamu:</label>
            <input type="text" id="username" placeholder="Contoh: Dedik"
                style="padding:12px; border:1px solid #E0E0E0; border-radius:10px; font-size:14px; background:#FFFFFF; box-shadow:0 2px 8px rgba(19,18,66,0.08); outline:none; font-family:'Montserrat',sans-serif;" />
        </div>
    </div>

    <button class="confirm-button" onclick="confirmSelection()" style="position:fixed; bottom:30px;">Konfirmasi</button>
</div>