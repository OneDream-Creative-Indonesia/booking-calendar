...
<head>
    ...
    <style>
        ...
        .success-icon { width: 100px; height: 100px; background-color: var(--primary-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 2rem; margin-top: 2rem; position: relative; }
          ...
          <div id="qrisModal" class="modal">
            ...
            <section id="page-sukses" class="page">
                <div class="success-container">
                    <div class="success-icon"><img src="{{ asset('img/Pinpin-01.png') }}" alt="" style="height:170px"></div>
